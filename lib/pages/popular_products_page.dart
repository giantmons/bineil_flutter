...
final List<Perfume> perfumeList = [
  ...
  Perfume(
    ...
    size: '100ml',
    rating: '4.7',
    review: 'Versace Eros is a powerful and sensual fragrance that is perfect for the passionate man. Its blend of fresh and oriental notes creates a bold and captivating scent.',
    category: 'Male',
  ),
  Perfume(
    name: 'Spicebomb',
    brand: 'Viktor & Rolf',
    price: '105.00 USD',
    imagePath: 'images/spicebomb.png',
    description: 'A bold and spicy fragrance with notes of chili, saffron, and leather.',
    size: '100ml',
    rating: '4.8',
    review: 'Spicebomb is an explosive and daring fragrance that is perfect for the adventurous man. Its blend of spicy and leather notes creates a unique and intense scent.',
    category: 'Male',
  ),
  Perfume(
    name: 'L’Homme',
    ...
    description: 'A fresh and woody fragrance with notes of ginger, basil, and cedar.',
    size: '100ml',
    rating: '4.7',
    review: 'L’Homme is a refined and elegant fragrance that is perfect for the modern man. Its blend of fresh and woody notes creates a sophisticated and masculine scent.',
    category: 'Male',
  ),
  Perfume(
    name: 'Terre d’Hermès',
