...
class EntryPage extends StatelessWidget {
  ...
  final List<Perfume> perfumeList = [
    ...
    Perfume(
      ...
      rating: '4.5',
      review:
          'A commanding fragrance with a powerful presence. The blend of spicy and woody notes is impressive, making it ideal for evening wear.',
      category: 'Male',
    ),
    Perfume(
      name: 'Sauvage Elixir',
      ...
      rating: '4.7',
      review:
          'Sauvage Elixir is a standout scent with a rich blend of spices and wood. Its magnetic allure is undeniable, though the price might be a bit steep for some.',
      category: 'Male',
    ),
    Perfume(
      name: 'Aventus',
    ...
    Perfume(
      ...
      rating: '4.8',
      review:
          'Interlude Man is an extraordinary fragrance with an intricate blend of smoky and spicy notes. Its complexity is its strength, making it ideal for special events.',
      category: 'Male',
    ),
    Perfume(
      name: 'Oud Wood',
      ...
      rating: '4.6',
      review:
          'Oud Wood is a beautifully refined scent with a luxurious blend of woody and spicy notes. It’s sophisticated and elegant but comes with a high price point.',
      category: 'Male',
    ),
    Perfume(
      ...
      rating: '4.4',
      review:
          'Layton offers a well-balanced fragrance with a blend of fresh and spicy notes. It’s versatile enough for various occasions, though its sweetness might be a bit much for some.',
      category: 'Male',
    ),
    Perfume(
      name: 'Grand Soir',
      ...
      rating: '4.7',
      review:
          'Grand Soir is a luxurious amber scent that creates a warm, inviting aura. It’s perfect for evening wear, although its sweetness might not be for everyone.',
      category: 'Male',
    ),
    Perfume(
      ...
      rating: '4.3',
      review:
          'La Nuit de L\'Homme is a seductive scent with a deep, spicy profile. It’s great for romantic occasions but may not be as long-lasting as other options.',
      category: 'Male',
    ),
    Perfume(
      ...
      rating: '4.5',
      review:
          'Colonia is a refreshing citrus scent that captures Italian elegance. It’s perfect for daytime wear but might be too subtle for some.',
      category: 'Male',
    ),
    Perfume(
      name: 'Prada L\'Homme',
      ...
      rating: '4.4',
      review:
          'Prada L\'Homme is a versatile fragrance that works well in both professional and casual settings. It’s fresh and refined but may lack depth for some preferences.',
      category: 'Male',
    ),
    Perfume(
      name: 'Bleu de Chanel',
      ...
      rating: '4.8',
      review:
          'Bleu de Chanel is a classic scent that exudes sophistication and style. It’s timeless and versatile, though the price might be a consideration for some.',
      category: 'Male',
    ),
    Perfume(
      ...
      rating: '4.6',
      review:
          'Acqua di Giò Profumo is a refreshing aquatic scent with a smoky twist. It’s versatile and invigorating, making it suitable for various occasions.',
      category: 'Male',
    ),
    Perfume(
      name: 'Man in Black',
      ...
      rating: '4.5',
      review:
          'Man in Black is a powerful and intense fragrance with a bold, leathery profile. It’s great for evening wear but might be too strong for everyday use.',
      category: 'Male',
    ),
    Perfume(
      name: 'Santal 33',
      ...
      rating: '4.7',
      review:
          'Santal 33 is a unique scent with a memorable woody and leathery profile. It’s sophisticated and adventurous but comes with a high price tag.',
      category: 'Male',
    ),
    ...
    Perfume(
      ...
      rating: '4.6',
      review:
          'Libre Le Parfum is a bold floral fragrance with a luxurious vanilla and lavender blend. It’s ideal for confident women, though its intensity might not suit everyone.',
      category: 'Female',
    ),
    Perfume(
        name: 'Angel\'s Share',
        ...
        rating: '4.8',
        review:
            'Angel\'s Share is an indulgent fragrance with a rich cognac-inspired scent. It’s perfect for evening wear and makes a warm, sensual statement.',
        category: 'Female'),
    Perfume(
        name: 'Goddess',
        brand: 'Burberry',
        ...
        rating: '4.4',
        review:
            'Goddess is a radiant and feminine fragrance that transitions well from day to night. Its blend of citrus and floral notes is graceful but might be too light for some.',
        category: 'Female'),
    Perfume(
        ...
        rating: '4.7',
        review:
            'Black Opium Le Parfum offers a bold and intense scent with rich vanilla and coffee notes.',
        category: 'Female'),
    Perfume(
        name: 'Devotion',
        ...
        rating: '4.5',
        review:
            'Devotion is a fresh and elegant fragrance with a vibrant citrus and floral blend. It’s great for everyday wear, though its warmth might not appeal to everyone.',
        category: 'Female'),
    Perfume(
        ...
        rating: '4.6',
        review:
            'Musc Noir Rose For Her is a sensual and feminine fragrance with a captivating blend of rose and musk. ',
        category: 'Female'),
    Perfume(
        name: 'Babycat',
        brand: 'Yves Saint Laurent',
        ...
        rating: '4.5',
        review:
            'Babycat is a soft and sensual scent with a warm suede base. It’s playful and alluring but comes with a higher price point.',
        category: 'Female'),
    Perfume(
        name: 'Guidance',
        brand: 'Amouage',
        ...
        rating: '4.8',
        review:
            'Guidance is an elegant fragrance with a sophisticated blend of fruity, floral, and woody notes. ',
        category: 'Female'),
    Perfume(
        name: 'Prada Paradoxe',
        brand: 'Prada',
        ...
        rating: '4.4',
        review:
            'Prada Paradoxe is a modern fragrance with a blend of citrus and floral notes. It’s versatile and complex, though its warmth may not appeal to everyone.',
        category: 'Female'),
    Perfume(
    ...
    Perfume(
        ...
        rating: '4.6',
        review:
            'Gris Charnel Extrait offers a rich and sophisticated scent with a complex blend of spices and wood.',
        category: 'Unisex'),
    Perfume(
        name: 'Tobacco Honey',
        brand: 'Guerlain',
    ...
    Perfume(
        ...
        rating: '4.7',
        review:
            'Golestan is an exotic and luxurious fragrance with a unique blend of rose and saffron. It’s perfect for those seeking something mystique and high-end.',
        category: 'Unisex'),
    Perfume(
        name: 'Nexin',
        brand: 'Tauer Perfumes',
        ...
        rating: '4.5',
        review:
            'Nexin offers a vibrant and elegant scent with a refreshing citrus and warm woody base. It’s invigorating but might not have the depth for some preferences.',
        category: 'Unisex'),
    Perfume(
        ...
        rating: '4.6',
        review:
            'Lascia Chio Pianga is a deep and evocative fragrance with a blend of fruity and leathery notes. It’s ideal for those who love a rich scent.',
        category: 'Unisex'),
    Perfume(
        name: 'Bake',
        brand: 'Akro',
        ...
        rating: '4.3',
        review:
            'Bake is a gourmand fragrance that brings the comfort of freshly baked goods. It’s cozy and inviting but might be too sweet for some tastes.',
        category: 'Unisex'),
    Perfume(
        name: 'Cherry Smoke',
        brand: 'Tom Ford',
        ...
        rating: '4.7',
        review:
            'Cherry Smoke offers a bold and sensual experience with a smoky cherry scent. It’s unforgettable but comes with a high price tag.',
        category: 'Unisex'),
    Perfume(
        ...
        rating: '4.4',
        review:
            'Cologne Officinale is a fresh and clean scent with a simple blend of citrus and herbs. It’s elegant for everyday wear but may lack complexity for some.',
        category: 'Unisex'),
    Perfume(
        name: 'Ani X',
        brand: 'Nishane',
        ...
        rating: '4.6',
        review:
            'Ani X is a versatile and elegant fragrance with a sophisticated blend of floral and woody notes. It’s ideal for any occasion but may be too complex for some preferences.',
        category: 'Unisex'),
    Perfume(
        ...
        rating: '4.5',
        review:
            'Un Jardin à Cythère offers a refreshing Mediterranean-inspired scent with citrus and fig. It’s invigorating but might lack depth for some.',
        category: 'Unisex'),
    Perfume(
        name: 'Tonka Cola',
        brand: 'Mancera',
        ...
        rating: '4.4',
        review:
            'Tonka Cola is a playful fragrance with a nostalgic cola scent and warm spices. It’s fun and unique but may not appeal to those who prefer traditional scents.',
        category: 'Unisex'),
    Perfume(
        ...
        rating: '4.7',
        review:
            'Vanille Antique is a luxurious vanilla fragrance with rich amber and woody notes. It’s perfect for indulgence but comes with a high price.',
        category: 'Unisex'),
    Perfume(
        ...
        rating: '4.8',
        review:
            'Opus XIV - Royal Tobacco is a regal and complex fragrance with spicy and tobacco notes. It’s sophisticated and distinguished but may be too intense for some.',
        category: 'Unisex'),
  ];
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'MEN PERFUMES',
                    style:
                        TextStyle(color: colorScheme.secondary, fontSize: 14),
                  ),
                  InkWell(
